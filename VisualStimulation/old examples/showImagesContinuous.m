...
frameRate=60; %Hz
imageDuration=10; %sec
preSession=30*60;
currentInterval=0;

nTrialsRegular=500; %per image
nTrialsHighlyRepeating=1000; %per image
highlyRepeatingImgNumber=8;
...
save imageContinuousSequences imageSequence imageFiles;
