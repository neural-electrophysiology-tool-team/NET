classdef VS_fullFieldFlash_retarder < VStim
    ...
    methods
        function obj=run(obj)
            ...
            fprintf(dg1000z, ':SOURce1:APPLy:SQUare 2000,12.4' );%set the waveform
            ...
            for i=1:obj.nTotTrials
                ...
                obj.sendTTL(2,true);
                fprintf(dg1000z, ':SOURce1:APPLy:SQUare 2000,1.8' ); %apply zero-wave retardance (incident angle)
        ...
        %class constractor
        function obj=VS_fullFieldFlash_retarder(w,h)
