...
% ROIRESPONSESERIES ROI responses over an imaging plane. Each row in data should correspond to the signal from one ROI. Each element on the second dimension of data should correspond to the signal from one ROI.
