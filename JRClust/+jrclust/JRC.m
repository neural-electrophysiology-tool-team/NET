    ...
    methods (Access=protected)
        ...
        function processArgs(obj)
            ...
            switch obj.cmd
               ...
               case {'import-gridSorter', 'import-gs'}
                   jrclust.import.import_gridSorter_(obj.args{1}, 0); 
                   obj.isCompleted = 1;
                   
               case {'export-gridSorter', 'export-gs'}
                   jrclust.import.export_gridSorter_(obj.args{1}, 0); 
                   obj.isCompleted = 1;
               
               case {'import-kilosort', 'import-ksort'}
                   jrclust.import.import_ksort_(obj.args{1}, 0); 
                   obj.isCompleted = 1;
                   
               case {'import-kilosort-sort', 'import-ksort-sort'}
                   jrclust.import.import_ksort_(obj.args{1}, 1);
                   obj.isCompleted = 1;
               ...
               % misc commands
                ...
                case {'kilosort', 'ksort'}
                   jrclust.clustering.kilosort_(obj.args{1}); 
                   jrclust.import.import_ksort_(obj.args{1}, 0); 
                   obj.isCompleted = 1;
            end
