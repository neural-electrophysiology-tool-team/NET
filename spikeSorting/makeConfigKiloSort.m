function ops=makeConfigKiloSort(sortingDir,nCh,varargin)
...
ops.whiteningRange      = 36; % how many channels to whiten together (Inf for whole probe whitening, should be fine if Nchan<=32)		
...
ops.Th               = [6 12 12];    % threshold for detecting spikes on template-filtered data ([6 12 12])	/ default=[4 10 10]
