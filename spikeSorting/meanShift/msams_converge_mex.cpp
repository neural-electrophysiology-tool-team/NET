 ...
 *     selected landmark(s) (as moving probe points)
 *   closestLandmark is the 1-by-q index of the landmark closest to each yf
...
void msams_wrapper(int nlhs, mxArray *plhs[],int nrhs, const mxArray *prhs[],bool (*validationFunction)(const mxArray*),mxClassID allocationTypeFlag)
{
  ...
  if (mxIsEmpty(curarg)) {
    ...
    y = x;
    q = N;
    ops.probePointsAreDataPoints = true;
  } else {
  ...
  */
  ...
  mxSetField(mxOutput,0,"closestLandmark",mxCreateDoubleMatrix(1,q,mxREAL));
...
void C2mat(const optionStruct &ops,mxArray *mxOptions)
{
  mxSetField(mxOptions,0,"min_to_check",mxCreateDoubleScalar(double(ops.n_min)));
  mxSetField(mxOptions,0,"factor",mxCreateDoubleScalar(ops.factor));
  mxSetField(mxOptions,0,"leapfrog",mxCreateDoubleScalar(double(ops.leapfrog)));
  mxSetField(mxOptions,0,"backtrack",mxCreateDoubleScalar(double(ops.backtrack)));
  mxSetField(mxOptions,0,"any_coordinate",mxCreateDoubleScalar(double(ops.any_coordinate)));
  mxSetField(mxOptions,0,"convergence_thresh",mxCreateDoubleScalar(ops.convergence_thresh));
  mxSetField(mxOptions,0,"max_iter",mxCreateDoubleScalar(double(ops.max_iter)));
  mxSetField(mxOptions,0,"n_threads",mxCreateDoubleScalar(double(ops.n_threads)));
}    
