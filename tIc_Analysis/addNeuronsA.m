%[I_new,t_new,ic_new]=addNeuronsA(I,t,ic,varargin);
%
...
function [I_new,t_new,ic_new]=addNeuronsA(I,t,ic,varargin)
%sort neurons in ascending order
times=varargin(2:3:end);
intensities=varargin(3:3:end);
chNames=cell2mat(varargin(1:3:end));
...
for i=1:nNeurons
    ...
    I_new=[I_new(1:(pInt-1)) intensities{i} I_new(pInt:end)];
