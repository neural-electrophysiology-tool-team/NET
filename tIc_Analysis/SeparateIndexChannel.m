%[ic_sep]=SeparateIndexChannel(ic);
%
% Function purpose :    reorders indexchannel to network A and B         
% Function recives :    t - firing timings
%                       ic - indexchannel  
%
% Function give back :  ic_sep-the index channel of the reordered separated networks
%                       
% Last updated : 11/07/05
function [ic_sep]=SeparateIndexChannel(ic);
